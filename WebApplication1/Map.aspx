...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <style>
        ...
        #orderbepid {
            ...
            font-weight: 600;
            color: #fff;
            background: #17a2b8; /* xanh giống action */
            border: none;
            border-radius: 6px;
            cursor: pointer;
            transition: all 0.2s ease;
    ...
    <style>
        /* ===== Mặc định A5 ===== */
        #printableArea.print-a5 {
            width: 700px;
            font-size: 22px;
        }

            #printableArea.print-a5 .qrcode img {
                width: 120px;
            }

        /* ===== Bill 80mm ===== */
        #printableArea.print-80 {
            width: 400px;
            font-size: 18px;
        }

            #printableArea.print-80 .qrcode img {
                width: 150px;
            }
   ...
   <%-- <link rel="stylesheet" href="../dist/contextmenu.css">
                    ...
                    <div class="col-md-6">
                        <div class="card card-secondary">
                            <div class="card-header">
                                ...
                                <h3 class="card-title">
                                    <b>Vị trí:</b>
                                    <b id="nametable" class="td_menu"></b>
                                </h3>
                               <%-- <i class="fa fa-plus-square" style="font-size: 24px; padding-left: 15px;"></i><b class="add_hanghoa" style="color: yellow; padding-left: 5px;">Thêm</b>
                                ...
                                <button class="saveproduct">
                                    <i class="fa fa-save"></i>
                                    Ghi Thực đơn
                                </button>

                                <button class="add_hanghoa">
                            ...
                            <div class="card-body">
                                           ...
                                           <%-- <td style="padding-bottom: 10px; padding-right: 10px; padding-left: 10px;">
                                            ...
                                            <td style="padding-bottom: 10px; padding-right: 10px; padding-left: 10px;">
                                                ...
                                                <label style="font-size:14px;">
                                                    <input type="checkbox" id="chkBill80">
                                                    In Khổ nhỏ
                                                </label>
                                            </td>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-2">
                                      ...
                                      <div class="col-2">
                                         <label for="VAT" style="float: left; margin-top: 5px;">VAT</label>
                                        <input type="text" id="VATid" class="form-control input-sm" name="fname" style="float: left; margin-left: 5px; font-size:22px; background-color:aqua; color:black;" value="0">                                    
                                    </div>
                               ...
                               <div class="row">
                                    <%--<input type="submit" value="Xem HD" id="khachthanhtoan2" class="btn btn-success" style="width:100px; margin-bottom:5px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;--%>
                                   <input type="submit" value="Tạm tính" id="khachthanhtoan2" class="btn btn-success" style="width:100px; margin-bottom:5px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                   <input type="submit" value="Thanh toán" id="ghilaihoadon"  class="btn btn-success" style="width:100px; margin-bottom:5px;margin-left:10px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                </div>
                                <div class="row">                                     
                                    <b style=" margin-top:10px;margin-right:5px;">Bằng chữ:</b> <span id="bangchuid2" style="font-weight:300; color:red; font-size:25px; padding-left:0px;"></span>
                                </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <!-- HEADER -->
            <div class="modal-header">
                <h4 class="modal-title">HÓA ĐƠN BÁN HÀNG</h4>
            ...
            <div class="modal-body">
                <!-- VÙNG IN -->
                <div id="printableArea" class="print-a5">
                    ...
                    <div class="container-fluid" style="width:100%;">
                        ...
                        <tr>
                            ...
                            <td style="width:75%; vertical-align:top;">
                                ...
                                <i style="font-size:18px;">Tên bàn:</i>
                                <b id="tenphong2" style="font-size:18px;"></b>                                

                                <i style="font-size:18px; margin-left:50px;">Số HĐ:</i>
                                <span id="sohoadon_" style="font-size:18px;"></span> <br />
                                
                                <span id="ngaytao_" style="font-size:18px;" hidden></span>

                                <i style="font-size:18px;">Giờ vào:</i>
                                <b style="font-size:16px;" id="giovao"></b>&nbsp;&nbsp;
                                <i style="font-size:18px;">Giờ ra:</i>
                                <b style="font-size:16px;" id="giora"></b><br />

                                <i style="font-size:18px;">Thời gian:</i>
                                <b style="font-size:16px;" id="tonggiohat"></b> Giờ :
                                <b style="font-size:16px;" id="tongphuthat"></b> Phút
                                &nbsp;&nbsp;&nbsp;
                                 <i style="font-size:18px; margin-left:50px;">Đơn giá:</i>
                                <b id="giohat_" style="font-size:18px;"></b> /h &nbsp;&nbsp;&nbsp;
                                <span style="display:none;">Tổng tiền hát:</span> <b id="tongtienhat2" style="display:none;"></b>
                            </td>

                            <!-- CỘT BÊN PHẢI: Ô VUÔNG CHỨA IMAGE -->
                            <td style="width:25%; text-align:right; vertical-align:top;">
                                <div style="
                                    ...
                                    margin-left:auto;
                                ">
                                    <img src="/static/images/logo.png" style="max-width:100%; max-height:100%;" />
                                </div>
                            </td>
                        </tr>
                    </table>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody id="tbnhaphang_inhoadon" style="font-size:22px;color:black;"></tbody>
                        </table>
                        ...
                        <p>
                            <i>Bằng chữ:</i>
                            <span id="bangchuid" style="font-size:22px;"></span>
                        </p>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-success" onclick="printDiv_Save()">
                    Thanh toán
                </button>
        ...
        <script>
            ...
            $('#khachthanhtoan2').click(function () {
                ...
                if (checkbox.checked == true) {
                                    ...
                                    if (myArr == '0') {
                                        ...
                                        for (var i = 0; i < blkstr.length; i++) {
                                            ...
                                            var newrow = '<tr class="themthucdon2">' +
                                                '<td id="stt" style="border: 1px soild black;">' + stt + '</td>' +
                                        ...
                                        $('#tongtienhat2').text(tongtienhat);
                                        //tiengiohat = $('#tiengioid').val();
                                        //$('#tongtienhat2').text(1000);
                                        $('#giovao').text(giovao);
                                        $('#giora').text(giora);
                                        $('#tonggiohat').text(sogiodung);
                                        $('#tongphuthat').text(sophutdung);
                    ...
                    $('#tieudein').text('HÓA ĐƠN THANH TOÁN (Tạm tính)');

                    $('#myModal6').modal('show');
                    //if (hinhthucnghi == 'Karaoke') {
                    //    $('#myModal6A5').modal('show');
                    //}
                    //else
                    //{
                    //    //cafe va nha hang
            ...
            function thanhtoanhoadon(tenphong2, tongtien2, chietkau2, thantoan2, conlai2, tienhat, sohoadon, idkhachhang, vat2, dongiahatphut, soluonghatphut) {
            ...
            $('#VATid').on('change', function () {
                var textcheck = $('#VATid').val();
                var tienchietkhau = $("#chietkhauid").val();
                ...
                if (textcheck.includes("%")) {
                    //alert("TextBox chứa ký tự phần trăm (%)");
                    var removeKytu = $("#VATid").val().replace(/%/g, "");
                    //alert(removeKytu);
                    if (parseInt(removeKytu) <= 100) // <100%
                    {
            ...
            function thanhtoanhoadon2() {
                ...
                var soluonghatphut = tongsophutdung;
                ...
                //bo phan nay di => vi da co su kien change roi
                //if (tiengiock != '0') {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.d != "NG") {
                            ...
                            //$('#ticketid').val(0);  //truong hop in hoa don se lay gia tri de truyen vao hoa don ==> khi khach thanh toan
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (objdata['Table'][0] != "")  //|| objdata ['Table'][0][0] != "0"
                        {
                            ...
                            var giohat = objdata['Table'][0][12];

                            var giovao = ngaytao;
                            var giora = objdata['Table'][0][7];
                            var tienvat = objdata['Table'][0][13];
                            var tienhat1phut = objdata['Table'][0][14];
                            var tongsophutdung = objdata['Table'][0][15];
                            var tienchietkhau = objdata['Table'][0][16];
                            ...
                            if (myArr == '0') {
                                ...
                                //const bangchu_hienthi2 = to_vietnamese(parseInt(tienhang) + parseInt(tongtienhat));
                                const bangchu_hienthi2 = to_vietnamese(parseInt(tienhang) + parseInt(tongtienhat) + parseInt(tienvat) - parseInt(tienchietkhau));
            ...
            function printDiv_Save() {
                ...
                //alert(chietkau2);
                ////alert(conlai2);
                var tienhat = $("#thanhtienhat").text().trim();
                ...
                //console.log("đơn giá hát:", dongiahatphut);
                //console.log("soluonghatphut:", soluonghatphut);

                //console.log("Tên phòng:", tenphong2);
                //console.log("Tổng tiền:", tongtien2);
                //console.log("khach thanh toan:", thantoan2);
                //console.log("Chiết khấu:", chietkau2);
                //console.log("Còn lại:", conlai2);
                //console.log("Số hóa đơn:", sohoadon);
                //console.log("Khách hàng:", idkhachhang);
                //console.log("VAT:", VAT2);    
                thanhtoanhoadon(tenphong2, tongtien2, chietkau2, thantoan2, conlai2, tienhat, sohoadon, idkhachhang, VAT2, dongiahatphut, soluonghatphut);
            }

            function printDiv_old(divId) {
