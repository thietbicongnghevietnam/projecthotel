...
namespace WebApplication1
{
    public partial class danhmuccauthanhdvt : System.Web.UI.Page
    {
        ...
        public void Timkiemmahang(object sender, EventArgs e)
        {
            ...
            dt1 = DataConn.StoreFillDS("NH_timkiemhanghoa", System.Data.CommandType.StoredProcedure, tenhang);
            if (dt1.Rows.Count > 0)
            {
                dt_dvt = DataConn.StoreFillDS("NH_DMCauthanhDVT", System.Data.CommandType.StoredProcedure);
            }
            ...
            {
                Page.ClientScript.RegisterStartupScript(Page.GetType(), "Message", "toastr.error('NG, khong ton tai!'); ", true);
            }
