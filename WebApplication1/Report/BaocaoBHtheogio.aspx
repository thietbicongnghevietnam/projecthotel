              ...
              <%--<div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                  ...
                  <tr role="row">
                      ...
                      <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1">Số HĐ</th>
                      <%--<th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1">type</th>--%>
                      <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1">Ngày giờ vào</th>
                      <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1">Ngày giờ ra</th>
                      <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1">Tổng thời gian thuê</th>
                      <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1">Tên Phòng/ Bàn</th>
                      <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1">Tiền phòng</th>
                      <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1">Tiền giờ hát</th>
