...
{
    public partial class Baocaosoquy : System.Web.UI.Page
    {
        ...
        public void Download_Click(object sender, EventArgs e)
        {
            ...
            dt_dowload = DataConn.StoreFillDS("NH_Baocaosoquy", System.Data.CommandType.StoredProcedure);


            System.Web.HttpResponse response = System.Web.HttpContext.Current.Response;
            Response.Clear();
            Response.Buffer = true;
            Response.AddHeader("content-disposition", "attachment;filename=Baocao_soquy.xls");
            Response.Charset = "";
