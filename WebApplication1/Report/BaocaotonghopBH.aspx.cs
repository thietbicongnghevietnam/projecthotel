...
{
    public partial class BaocaotonghopBH : System.Web.UI.Page
    {
        ...
        void loaddata()
        {
            ...
            {
                dt_items = DataConn.StoreFillDS("NH_BC_tonghopBH", System.Data.CommandType.StoredProcedure);
            }
            else
            {
                //loc theo ngay
                dt_items = DataConn.StoreFillDS("NH_BC_tonghopBH_theongay", System.Data.CommandType.StoredProcedure, fromdate, todate);
            }
        ...
        public static string thongtinthekho(string mahang, string fromdate, string todate)  //string tenphong, string tienhang
        {
            ...
            dtthekho = DataConn.StoreFillDS("NH_thongtinthekho_BH", System.Data.CommandType.StoredProcedure, mahang, fromdate, todate);//tenphong, data, tienhang
