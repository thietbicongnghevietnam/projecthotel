<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BaocaotonghopNH.aspx.cs" Inherits="WebApplication1.Report.BaocaotonghopNH" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
     <title>Báo cáo tổng hợp nhập hàng</title>
    ...
    <form id="form1" runat="server">
           <div>
            ...
            <div class="card-header">
                <h1>Báo cáo tổng hợp nhập hàng</h1>
                <br />
                <%--class="card-title"--%>
                <div class="col-sm-12">
                    Tu ngay:
                    ...
                    <button class="btn btn-primary" type="button" style="margin-left:20px;" id="exportBtn">Xuất báo cáo</button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <div class="row">
                            <div>
                                <h4 class="modal-title" id="headerTag" style="float: left">Thông tin nhập kho chi tiết</h4>
       ...
       //});
         ...
         function openEditModal2(mahang) {   
            ...
            $.ajax({
                ...
                url: "BaocaotonghopNH.aspx/thongtinthekho",
