...
namespace WebApplication1.Report
{
    public partial class Baocaotonghopthuchi : System.Web.UI.Page
    {
        ...
        public void Download_Click(object sender, EventArgs e)
        {
            ...
            dt_dowload = DataConn.StoreFillDS("NH_Baocaosoquy_theongay", System.Data.CommandType.StoredProcedure, _fromdate, _todate);


            System.Web.HttpResponse response = System.Web.HttpContext.Current.Response;
            Response.Clear();
            Response.Buffer = true;
            Response.AddHeader("content-disposition", "attachment;filename=Baocao_soquytheongay.xls");
            Response.Charset = "";
