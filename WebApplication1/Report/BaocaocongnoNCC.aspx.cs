...
namespace WebApplication1.Report
{
    public partial class BaocaocongnoNCC : System.Web.UI.Page
    {
        ...
        public void Download_Click(object sender, EventArgs e)
        {
            ...
            string _fromdate = Request.Form[Date1.UniqueID];
            string _todate = Request.Form[ngaychiid.UniqueID];
            dt_dowload = DataConn.StoreFillDS("NH_Baocaocongno_theongay_NCC", System.Data.CommandType.StoredProcedure, _fromdate, _todate);
            ...
            Response.AddHeader("content-disposition", "attachment;filename=Baocao_congnoNCC.xls");
            Response.Charset = "";
