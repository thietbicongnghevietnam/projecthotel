<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BaocaocongnoKH.aspx.cs" Inherits="WebApplication1.Report.BaocaocongnoKH" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Báo cáo công nợ KH</title>
   ...
   $(document).ready(function () {            
        ...
        function openEditModal2(makh) {           
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "BaocaocongnoKH.aspx/thongtinKH",
                //data: JSON.stringify(data),
                data: JSON.stringify(data),
                dataType: "json",
                success: function (data) {
