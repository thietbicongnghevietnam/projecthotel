...
{    
    public partial class BaocaocongnoKH : System.Web.UI.Page
    {
        ...
        public void Download_Click(object sender, EventArgs e)
        {
            ...
            string _fromdate = Request.Form[Date1.UniqueID];
            string _todate = Request.Form[ngaychiid.UniqueID];
            dt_dowload = DataConn.StoreFillDS("NH_Baocaocongno_theongay", System.Data.CommandType.StoredProcedure, _fromdate, _todate);

            System.Web.HttpResponse response = System.Web.HttpContext.Current.Response;
            Response.Clear();
            Response.Buffer = true;
            Response.AddHeader("content-disposition", "attachment;filename=Baocao_congngokhachang.xls");
            Response.Charset = "";
