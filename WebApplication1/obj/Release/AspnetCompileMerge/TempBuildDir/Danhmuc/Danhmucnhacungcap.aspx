<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Danhmucnhacungcap.aspx.cs" Inherits="WebApplication1.Danhmuc.Danhmucnhacungcap" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Danh mục NCC</title>
    ...
    <form id="form1" runat="server">
        ...
        <tbody>
                                <%int i = 0; %>
                                    ...
                                    <tr role="row">                                        
                                        <td><%=i %></td>
                                        <td><%=rows["mancc"].ToString()%></td>
                                        <td><%=rows["tenncc"].ToString()%></td>
                                        <td><%=rows["congnodi"].ToString()%></td>
                                        
                                        <td>
                                            <a href="#" class="btn btn-info btn-sm" title="delete item" onclick="openEditModal2('<%= rows["mancc"].ToString() %>','<%= rows["tenncc"].ToString() %>')"><i class="fas fa-pencil-alt"></i>Sửa</a>
                                        </td> 
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <div class="row">
                            <div>
                                <h4 class="modal-title" id="headerTag" style="float: left">Sửa tên nhà cung cấp</h4>
