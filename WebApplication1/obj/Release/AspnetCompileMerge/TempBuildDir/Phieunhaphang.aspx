     ...
     <script type="text/javascript">
                         ...
                         if (data.d != "NG") {
                             ...
                             if (checkbox.checked == true) {
                                 ...
                                 $.ajax({
                                     type: "POST",
                                     contentType: "application/json; charset=utf-8",
                                     url: "Phieunhaphang.aspx/updatetonkhosuahang",
                                     data: JSON.stringify(data2),
                                     dataType: "json",
                             ...
                             $.ajax({
                                 type: "POST",
                                 contentType: "application/json; charset=utf-8",
                                 url: "Phieunhaphang.aspx/danhsachhanghoacantim",
                                 //data: JSON.stringify(data),
                                 data: JSON.stringify(data2),
                                 dataType: "json",
                                 success: function (data) {
                 ...
                 $('.checknhaphang').each(function () {
                     ...
                     if (chk == true) {
                         ...
                         $.ajax({
                             type: "POST",
                             contentType: "application/json; charset=utf-8",
                             url: "Phieunhaphang.aspx/updatetonkhoxoahang_nhap",
                             data: JSON.stringify(data2),
                             dataType: "json",
                             success: function (data) {
                                 //alert(data.d);                                                                                              
                     ...
                     if (idhoadon == '0') {
                         ...
                         $.ajax({
                             ...
                             success: function (data) {
                                 ...
                                 //alert(khachthanhtoan);
                                 //alert(sohoadon);
                                 $('#tbnhaphang_inhoadon tr22').remove();
          ...
          $('#xemlaiHD').on('change', function () {
              if (!this.checked) {
                  $.ajax({
                         type: "POST",
                         contentType: "application/json; charset=utf-8",
                         url: "Phieunhaphang.aspx/Reset_edit_temp",
                         //data: JSON.stringify(data2),
                         dataType: "json",
                         success: function (data2) {
                             //alert(data.d);  
                 ...
                 if (userInput != null) {
                     ...
                     if (userInput == '123456') {
                         ...
                         $.ajax({
                             type: "POST",
                             contentType: "application/json; charset=utf-8",
                             url: "Phieunhaphang.aspx/Xemlaihoadon",
                             data: JSON.stringify(data),
                             dataType: "json",
                             success: function (data) {
                                 const objdata = $.parseJSON(data.d);
         ...
         $("#dvtid").change(function () {
             ...
             $.ajax({
                 type: "POST",
                 contentType: "application/json; charset=utf-8",
                 url: "Phieunhaphang.aspx/dongiacauthanhdvt",
                 data: JSON.stringify(data),
                 dataType: "json",
                 success: function (data) {
                     //const objdata = $.parseJSON(data.d);
