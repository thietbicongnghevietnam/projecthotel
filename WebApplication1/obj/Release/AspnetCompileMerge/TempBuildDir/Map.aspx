                    ...
                    <div class="container-fluid" style="width:100%;">
                        ...
                        <tr>
                            ...
                            <td style="width:75%; vertical-align:top;">
                                <span style="font-size:30px;color:black;"><%=tendovi %></span><br />
                                <i style="font-size:24px;">Địa chỉ: <%=diachidonvi %></i><br />
                                <i style="font-size:24px;">SĐT:</i>
                                <span style="font-size:26px;"><%=sodtdonvi %></span><br />

                                <i style="font-size:28px;" id="tieudein">PHIẾU TẠM TÍNH</i><br />

                                <i style="font-size:24px;">Số HĐ:</i>
                                <span id="sohoadon_" style="font-size:24px;"></span>&nbsp;&nbsp;&nbsp;
                                <i style="font-size:24px;">Tên bàn:</i>
                                <b id="tenphong2" style="font-size:26px;"></b><br />

                                <span id="ngaytao_" style="font-size:24px;" hidden></span>
                                ...
                                &nbsp;&nbsp;&nbsp;
                                <span>Tổng tiền hát:</span> <b id="tongtienhat2"></b>
                            </td>
