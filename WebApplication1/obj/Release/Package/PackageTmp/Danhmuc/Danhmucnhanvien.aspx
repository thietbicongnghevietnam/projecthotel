<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Danhmucnhanvien.aspx.cs" Inherits="WebApplication1.Danhmuc.Danhmucnhanvien" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <tbody>
                                <%int i = 0; %>
                                    <%foreach (System.Data.DataRow rows in dt_nhanvien.Rows)
                                        {%>
                                     <%i++;%>
                                    <tr role="row">                                        
                                        <td><%=i %></td>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <div class="row">
                            <div>
                                <h4 class="modal-title" id="headerTag" style="float: left">Sửa thông tin nhân viên</h4>
                         ...
                         <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <span style="color: red; font-size: 11px; font-style: italic;">You must input!(*)</span>
                                        <asp:TextBox ID="matkhauid" CssClass="form-control" placeholder="0" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
