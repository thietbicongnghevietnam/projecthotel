<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Phieuchi.aspx.cs" Inherits="WebApplication1.Phieuchi" %>
    ...
    <h2>Phiếu Chi</h2>
      ...
      <div class="row">
        ...
        <div class="column">
          ...
          <div class="form-group">
            <label for="balance" style="padding-top:5px;">Công nợ nhà cung cấp:</label>
     ...
     <script type="text/javascript">
         ...
         $('#MainContent_dr_nhacungcap').on('change', function () {
             ...
             $.ajax({
                    ...
                    url: "Phieuchi.aspx/NH_getcongno",
