<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hethongbaocadong.aspx.cs" Inherits="WebApplication1.TemplateReport.hethongbaocadong" %>
...
<head runat="server">
    ...
    <script src="../plugins/toastr/crypto-js.min.js"></script>
                    ...
                    if (confirm("Bạn có chắc muốn thực thi câu lệnh?") == true) {
                        ...
                        modal.style.display = "block";
                            ...
                            if (passwordInput.trim() !== "") {                                
                                if (hashedPassword === '6aa77039a2c86a4b3937d30ad59f5f7b') {
