...
<body>
    ...
    <h1 style="padding-top: 7pt;padding-left: 10pt;text-indent: 0pt;text-align: left;">Báo cáo bán hàng theo ngày  <br /> <span class="s1">Từ ngày :<%=tungay %> Đến ngày :<%=denngay %></span></h1>
