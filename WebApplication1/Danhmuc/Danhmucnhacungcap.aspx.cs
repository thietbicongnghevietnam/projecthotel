...
namespace WebApplication1.Danhmuc
{
    public partial class Danhmucnhacungcap : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                dt_khachang = DataConn.StoreFillDS("NH_danhmucnhacungcap", System.Data.CommandType.StoredProcedure);
            }
        }
        ...
        public void themkhuvuc(object sender, EventArgs e)
        {
            ...
            string congnoden = congnodiid.Text;

            DataTable dtinsert = new DataTable();
            dtinsert = DataConn.StoreFillDS("NH_insert_DMnhacungcap", System.Data.CommandType.StoredProcedure, makhuvuc, tenkhuvuc, congnoden);
        ...
        public void updatekhuvuc(object sender, EventArgs e)
        {
            ...
            dtupdate = DataConn.StoreFillDS("NH_Update_nhacungcap", System.Data.CommandType.StoredProcedure, makhuvuc, tenkhuvuc);
        ...
        public void Download_Click(object sender, EventArgs e)
        {
            ...
            dt_dowload = DataConn.StoreFillDS("NH_danhmucnhacungcap", System.Data.CommandType.StoredProcedure);            

            System.Web.HttpResponse response = System.Web.HttpContext.Current.Response;
            Response.Clear();
            Response.Buffer = true;
            Response.AddHeader("content-disposition", "attachment;filename=DanhmucNCC.xls");
            Response.Charset = "";
