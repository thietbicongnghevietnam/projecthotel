<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DMKhuvuc.aspx.cs" Inherits="WebApplication1.Danhmuc.DMKhuvuc" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Danh mục khuc vực</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <tbody>
                                <%int i = 0; %>
                                    <%foreach (System.Data.DataRow rows in dt_khuvuc.Rows)
                                        {%>
                                     <%i++;%>
                                    <tr role="row">                                        
                                        <td><%=i %></td>
                                        <td><%=rows["makhuvuc"].ToString()%></td>
                                        <td><%=rows["tenkhuvuc"].ToString()%></td>
                                        
                                        <td>
                                            <a href="#" class="btn btn-info btn-sm" title="delete item" onclick="openEditModal2('<%= rows["makhuvuc"].ToString() %>','<%= rows["tenkhuvuc"].ToString() %>')"><i class="fas fa-pencil-alt"></i>Sửa</a>
                                        </td> 
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <div class="row">
                            <div>
                                <h4 class="modal-title" id="headerTag" style="float: left">Sửa Khu vực</h4>
