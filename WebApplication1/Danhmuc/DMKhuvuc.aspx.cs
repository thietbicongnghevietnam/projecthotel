...
{
    public partial class DMKhuvuc : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                dt_khuvuc = DataConn.StoreFillDS("NH_danhmuckhuvuc", System.Data.CommandType.StoredProcedure);
            }
        }
        public void themkhuvuc(object sender, EventArgs e)
        {
            ...
            dtinsert = DataConn.StoreFillDS("NH_insert_khuvuc", System.Data.CommandType.StoredProcedure, makhuvuc, tenkhuvuc);
        ...
        public void updatekhuvuc(object sender, EventArgs e)
        {
            ...
            dtupdate = DataConn.StoreFillDS("NH_Update_khuvuc", System.Data.CommandType.StoredProcedure, makhuvuc, tenkhuvuc);
        ...
        public void Download_Click(object sender, EventArgs e)
        {
            ...
            dt_dowload = DataConn.StoreFillDS("NH_danhmuckhuvuc", System.Data.CommandType.StoredProcedure);

            System.Web.HttpResponse response = System.Web.HttpContext.Current.Response;
            Response.Clear();
            Response.Buffer = true;
            Response.AddHeader("content-disposition", "attachment;filename=Danhmuckhuvuc.xls");
            Response.Charset = "";
